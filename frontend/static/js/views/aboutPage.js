            ...
            <div id="aboutPage" class="page">
                ...
                <div class="page_body">
                    ...
                    <div class="image_container">
                        <img 
                            src="/static/assets/face1.png"
                            onmouseover="this.src='/static/assets/angry.svg'"
                            onmouseout="this.src='/static/assets/face1.png'"
                            onclick="this.src='/static/assets/face2.png'"
                        >
                    </div>
                </div>
            </div>
